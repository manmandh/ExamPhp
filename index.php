...
<body>
    <div class="container my-5">
        ...
        <h2>Student table</h2>
        <a class="btn btn-primary" href="/22ITEB050_TranManMan/createStudent.php" role="button">New Student</a>
        <br>
        <table class="table">
            <thead>
                <tr>
            ...
            <tbody>
                ...
                $sql = "SELECT * FROM student where lastname like '%$find%'";
